function J=region_growing_hsv(I, obj, reg_maxdist)
...
x = floor(obj.Centroid(2)); y = floor(obj.Centroid(1));
lim_size = obj.BoundingBox(3)*obj.BoundingBox(4);
...
while(pixdist<reg_maxdist&&reg_size<lim_size)
